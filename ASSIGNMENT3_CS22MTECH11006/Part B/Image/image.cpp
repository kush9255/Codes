...
void read_file(int socket_id)
{
 ...
 if(fp == NULL)
  ...
  cout << "file size while reading : " << filelen << endl;
...
int main()
{
  ...
  string sendData = "1*3009*1234*127.0.0.2/";
  string token_code = "1234";
  // socket creation
...
pid_t childpid;
  ...
  inet_pton(AF_INET, "127.0.0.2", &(tcp_server.sin_addr)); ///////////////// CHECK
